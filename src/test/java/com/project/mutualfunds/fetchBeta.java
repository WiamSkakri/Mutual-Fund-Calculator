package com.project.mutualfunds;
...
public class fetchBeta {
    ...
    public static void main(String[] args) {
        ...
        double beta = fetchBeta.getBeta("VFFSX", "SPY", "1mo", 48);
        System.out.println("Beta: " + beta);

        double beta2 = fetchBeta.getBeta("AGTHX", "SPY", "1mo", 10);

        System.out.println("Beta: " + beta2);

        double beta3 = fetchBeta.getBeta("DODGX", "SPY", "1mo", 48);
